...
Example:- sudo nano /etc/nginx/sites-available/sunny.com
```
...
Example:- sudo ln -s /etc/nginx/sites-available/sunny.com /etc/nginx/sites-enabled/sunny.com
```
...
Example:- ssh-keygen -f /home/sunny/.ssh/gitaction_ed25519 -t ed25519 -C "gitactionautodep"
```
...
```sh
Syntax:- ssh -p PORT USERNAME@HOSTIP
Example:- ssh -p 22 sunny@216.32.44.12
```
